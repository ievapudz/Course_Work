...
A small script to collect respective predictions was written:
```
./scripts/misc/merge_mean_per_tok.py thermoclass/predictions/TSV/Cas12a_1022_splits.tsv 2 thermoclass/predictions/Cas12a_1022_splits_per_tok_averaged.tsv 1 && mv merged.tsv thermoclass/predictions/Cas12a_1022_splits_mean_vs_per_token_averaged.tsv

./scripts/misc/merge_mean_per_tok.py thermoclass/predictions/TSV/Cas12b_1022_splits.tsv 2 thermoclass/predictions/Cas12b_1022_splits_per_tok_averaged.tsv 1 && mv merged.tsv thermoclass/predictions/Cas12b_1022_splits_mean_vs_per_token_averaged.tsv
```
...
Mean analysis:
```
echo -e "seq_id\tN_mean\tsubseq_1_mean\tdelta" > thermoclass/predictions/Cas12a_N_vs_subseq_1_mean.tsv
...
Per token analysis:
```
echo -e "seq_id\tN_averaged_per_tok\tsubseq_1_averaged_per_tok\tdelta" > thermoclass/predictions/Cas12a_N_vs_subseq_1_per_tok.tsv
...
```
paste thermoclass/predictions//Cas12a_N_vs_subseq_1_mean.tsv thermoclass/predictions/Cas12a_N_vs_subseq_1_per_tok.tsv | awk 'BEGIN{OFS="\t"}{print $1, $2, $3, $4, $6, $7, $8}' | column -t > thermoclass/predictions/Cas12a_N_overlap_analysis.tsv
```
...
Mean analysis:
```
echo -e "seq_id\tC_mean\tsubseq_2_mean\tdelta" > thermoclass/predictions/Cas12a_C_vs_subseq_2_mean.tsv
...
Per token analysis:
```
echo -e "seq_id\tC_averaged_per_tok\tsubseq_2_averaged_per_tok\tdelta" > thermoclass/predictions/Cas12a_C_vs_subseq_2_per_tok.tsv
...
```
paste thermoclass/predictions/Cas12a_C_vs_subseq_2_mean.tsv thermoclass/predictions/Cas12a_C_vs_subseq_2_per_tok.tsv | awk 'BEGIN{OFS="\t"}{print $1, $2, $3, $4, $6, $7, $8}' | column -t > thermoclass/predictions/Cas12a_C_overlap_analysis.tsv
```
