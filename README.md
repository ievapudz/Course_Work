...
In order to merge and compare results from N / C term analysis and first / second split of 1022 length sequences analysis, the following commands
were executed:
```
tail -n +2 thermoclass/predictions/Cas12a_1022_splits_mean_vs_per_token_averaged.tsv | awk 'BEGIN{OFS="\t"; print "seq_id", "mean", "averaged_per_tok"}{ if(NR % 2 == 1) print $1, $2, $3}' | sed 's/_1\t/\t/' > thermoclass/predictions/Cas12a_1022_splits_1_mean_vs_averaged_per_tok.tsv

tail -n +2 thermoclass/predictions/Cas12a_1022_splits_mean_vs_per_token_averaged.tsv | awk 'BEGIN{OFS="\t"; print "seq_id", "mean", "averaged_per_tok"}{ if(NR % 2 == 0) print $1, $2, $3}' | sed 's/_2\t/\t/' > thermoclass/predictions/Cas12a_1022_splits_2_mean_vs_averaged_per_tok.tsv

tail -n +2 thermoclass/predictions/Cas12b_1022_splits_mean_vs_per_token_averaged.tsv | awk 'BEGIN{OFS="\t"; print "seq_id", "mean", "averaged_per_tok"}{ if(NR % 2 == 1) print $1, $2, $3}' | sed 's/_1\t/\t/' > thermoclass/predictions/Cas12b_1022_splits_1_mean_vs_averaged_per_tok.tsv

tail -n +2 thermoclass/predictions/Cas12b_1022_splits_mean_vs_per_token_averaged.tsv | awk 'BEGIN{OFS="\t"; print "seq_id", "mean", "averaged_per_tok"}{ if(NR % 2 == 0) print $1, $2, $3}' | sed 's/_2\t/\t/' > thermoclass/predictions/Cas12b_1022_splits_2_mean_vs_averaged_per_tok.tsv
```

The `./scripts/misc/merge_mean_per_tok.py` was updated to have a more universal output (header in particular).

Cas12a N:

Mean analysis:
```
echo -e "seq_id\tN_mean\tsubseq_1_mean\tmean_delta" > thermoclass/predictions/Cas12a_N_vs_subseq_1_mean.tsv

./scripts/misc/merge_mean_per_tok.py thermoclass/predictions/TSV/Cas12a_N_mean.tsv 2 thermoclass/predictions/Cas12a_1022_splits_1_mean_vs_averaged_per_tok.tsv 1 >> thermoclass/predictions/Cas12a_N_vs_subseq_1_mean.tsv
```

Per token analysis:
```
echo -e "seq_id\tN_averaged_per_tok\tsubseq_1_averaged_per_tok\tper_tok_delta" > thermoclass/predictions/Cas12a_N_vs_subseq_1_per_tok.tsv

./scripts/misc/merge_mean_per_tok.py thermoclass/predictions/TSV/Cas12a_N_per_tok_averaged.tsv 1 thermoclass/predictions/Cas12a_1022_splits_1_mean_vs_averaged_per_tok.tsv 2 >> thermoclass/predictions/Cas12a_N_vs_subseq_1_per_tok.tsv
```

Merging into N analysis table:
```
paste thermoclass/predictions//Cas12a_N_vs_subseq_1_mean.tsv thermoclass/predictions/Cas12a_N_vs_subseq_1_per_tok.tsv | awk 'BEGIN{OFS="\t"}{print $1, $2, $3, $4, $6, $7, $8}' > thermoclass/predictions/Cas12a_N_overlap_analysis.tsv
```
...
Mean analysis:
```
echo -e "seq_id\tC_mean\tsubseq_2_mean\tmean_delta" > thermoclass/predictions/Cas12a_C_vs_subseq_2_mean.tsv

./scripts/misc/merge_mean_per_tok.py thermoclass/predictions/TSV/Cas12a_C_mean.tsv 2 thermoclass/predictions/Cas12a_1022_splits_2_mean_vs_averaged_per_tok.tsv 1 >> thermoclass/predictions/Cas12a_C_vs_subseq_2_mean.tsv
```

Per token analysis:
```
echo -e "seq_id\tC_averaged_per_tok\tsubseq_2_averaged_per_tok\tper_tok_delta" > thermoclass/predictions/Cas12a_C_vs_subseq_2_per_tok.tsv

./scripts/misc/merge_mean_per_tok.py thermoclass/predictions/TSV/Cas12a_C_per_tok_averaged.tsv 1 thermoclass/predictions/Cas12a_1022_splits_2_mean_vs_averaged_per_tok.tsv 2 >> thermoclass/predictions/Cas12a_C_vs_subseq_2_per_tok.tsv
```

Merging into C analysis table:
```
paste thermoclass/predictions/Cas12a_C_vs_subseq_2_mean.tsv thermoclass/predictions/Cas12a_C_vs_subseq_2_per_tok.tsv | awk 'BEGIN{OFS="\t"}{print $1, $2, $3, $4, $6, $7, $8}' > thermoclass/predictions/Cas12a_C_overlap_analysis.tsv
```
...
Mean analysis:
```
echo -e "seq_id\tN_mean\tsubseq_1_mean\tmean_delta" > thermoclass/predictions/Cas12b_N_vs_subseq_1_mean.tsv

./scripts/misc/merge_mean_per_tok.py thermoclass/predictions/TSV/Cas12b_N_mean.tsv 2 thermoclass/predictions/Cas12b_1022_splits_1_mean_vs_averaged_per_tok.tsv 1 >> thermoclass/predictions/Cas12b_N_vs_subseq_1_mean.tsv
```

Per token analysis:
```
echo -e "seq_id\tN_averaged_per_tok\tsubseq_1_averaged_per_tok\tper_tok_delta" > thermoclass/predictions/Cas12b_N_vs_subseq_1_per_tok.tsv

./scripts/misc/merge_mean_per_tok.py thermoclass/predictions/TSV/Cas12b_N_per_tok_averaged.tsv 1 thermoclass/predictions/Cas12b_1022_splits_1_mean_vs_averaged_per_tok.tsv 2 >> thermoclass/predictions/Cas12b_N_vs_subseq_1_per_tok.tsv
```

Merging into N analysis table:
```
paste thermoclass/predictions/Cas12b_N_vs_subseq_1_mean.tsv thermoclass/predictions/Cas12b_N_vs_subseq_1_per_tok.tsv | awk 'BEGIN{OFS="\t"}{print $1, $2, $3, $4, $6, $7, $8}' > thermoclass/predictions/Cas12b_N_overlap_analysis.tsv
```
...
Mean analysis:
```
echo -e "seq_id\tC_mean\tsubseq_2_mean\tmean_delta" > thermoclass/predictions/Cas12b_C_vs_subseq_2_mean.tsv

./scripts/misc/merge_mean_per_tok.py thermoclass/predictions/TSV/Cas12b_C_mean.tsv 2 thermoclass/predictions/Cas12b_1022_splits_2_mean_vs_averaged_per_tok.tsv 1 >> thermoclass/predictions/Cas12b_C_vs_subseq_2_mean.tsv
```

Per token analysis:
```
echo -e "seq_id\tC_averaged_per_tok\tsubseq_2_averaged_per_tok\tper_tok_delta" > thermoclass/predictions/Cas12b_C_vs_subseq_2_per_tok.tsv

./scripts/misc/merge_mean_per_tok.py thermoclass/predictions/TSV/Cas12b_C_per_tok_averaged.tsv 1 thermoclass/predictions/Cas12b_1022_splits_2_mean_vs_averaged_per_tok.tsv 2 >> thermoclass/predictions/Cas12b_C_vs_subseq_2_per_tok.tsv
```

Merging into C analysis table:
```
paste thermoclass/predictions/Cas12b_C_vs_subseq_2_mean.tsv thermoclass/predictions/Cas12b_C_vs_subseq_2_per_tok.tsv | awk 'BEGIN{OFS="\t"}{print $1, $2, $3, $4, $6, $7, $8}' | column -t > thermoclass/predictions/Cas12b_C_overlap_analysis.tsv
```

Cleaning the working environment:
```
rm thermoclass/predictions/Cas12?_N_vs_*.tsv
rm thermoclass/predictions/Cas12?_C_vs_*.tsv
rm thermoclass/predictions/Cas12?_1022_splits_*.tsv
```
