...
predictions_out_file = 'results/regressor/003/testing_4_real_and_predictions_z_scores.tsv'

command = 'echo "temperature\tprediction" >'+predictions_out_file
...
test_epoch(regressor, test_loader, BATCH_SIZE,
           ...
           file_for_predictions=predictions_out_file)
