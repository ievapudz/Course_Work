...
\begin{document}
	...
	that relies entirely on self-attention (Vaswani et al. 2017). 
	...
	models of Transformer architecture, taking BERT model as a example 
	(Vig et al. 2020), are capable to capture the folding structure, 
	...
	unsupervised fashion on UniRef50 data set (accessed March 28, 2018). In order 
	to ensure
	...
	annotated organisms (Engqvist 2018). 
