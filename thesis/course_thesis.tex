...
\begin{document}
	...
	\begin{figure}[h!]
		\centering
		\includegraphics[scale=0.5]{training_v2_histo.png}
		\includegraphics[scale=0.5]{validation_v2_histo.png}
		\includegraphics[scale=0.5]{testing_v2_histo.png}

		\caption{Protein sequences distribution 
		regarding to organism's growth temperature
		in data subsets for training, validation, and testing}
		\label{figure:histograms003}
	\end{figure}
